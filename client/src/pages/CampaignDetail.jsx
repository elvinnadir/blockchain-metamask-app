  ...
  return (
    <div>
      ...
      <div className='w-full flex md:flex-row flex-col mt-10 gap-[30px]'>
        ...
        <div className='flex md:w-[150px] h-full flex-wrap
        ...
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div>
            ...
            <div className='mt-[20px] flex flex-row
              ...
              flex items-center justify-center bg-[#2c2f32] cursor-pointer'>
                <img
                  src={thirdweb}
                  alt="user"
              ...
              <div>
                <h4 className='font-epilogue font-semibold text-white
                 text-[14px] break-all'>{state.owner}</h4>
          ...
          <div>
            ...
            <div className="mt-[20px]">
              <p className='font-epilogue font-normal
               text-[16px] leading-[26px] text-[#808191] text-justify'>
                {state.description}
              </p>
            </div>
          </div>
